...
class Block(nn.Module):
    def __init__(self, dim, drop_path=0.1, drop_out=0.1):
        super().__init__()
...
class PACINGV8(nn.Module):
    def __init__(self, seq_len=1024, n_embd=768, num_layers=10, vocab_size=50257, in_channels=3):
        super().__init__()
