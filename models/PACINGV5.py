...
GPT style hidden state, but only predict next token
...
class PACINGV5(nn.Module):
    def __init__(self, seq_len=1024, emb_dim=256, num_blocks=10, vocab_size=50257, distil:GPT2LMHeadModel|None|bool = False):
        super().__init__()
